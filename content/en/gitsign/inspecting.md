...
As part of signature verification, Gitsign not only checks that the given signature matches the commit, but also that the commit exists within the [Rekor](/rekor/overview) transparency log.
