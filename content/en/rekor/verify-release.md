...
Woah, that's a lot of stuff. Let's focus on the the body and decode it from base64:
...
We can then grab the signing certicate:
...
In turn, this account has 2FA enabled and is monitored for misuse, since records are tranparent within the public Rekor transparency log.
