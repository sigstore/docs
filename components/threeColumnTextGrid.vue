        ...
        <div class="container">
            ...
            <div class="md:flex items-start md:-ml-30 md:-mr-30" :class="[column3.header ? 'justify-between':'justify-start']">
                ...
                class="w-full md:w-1/3 md:max-w-352 md:ml-30 mb-44 relative">
                    ...
                    <a 
                        v-if="column1.ctaLink" 
                        class="pt-24 flex items-center h text-12 md:text-16 inline--button-grey"
                        :class="[column1.isCardStyle ? 'absolute mb-40 bottom-0' : null]" 
                        :href="column1.ctaLink"
                        >
                            {{column1.ctaText}}
                            <span class="ml-6">
                ...
                class="w-full md:w-1/3 md:max-w-352 md:ml-30 mb-44 relative">
                    ...
                    <a 
                        v-if="column2.ctaLink" 
                        class="pt-24 flex items-center h text-12 md:text-16 inline--button-grey"
                        :class="[column2.isCardStyle ? 'absolute mb-40 bottom-0' : null]"  
                        :href="column2.ctaLink"
                    >
                        {{column2.ctaText}}
                        <span class="ml-6">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                class="mb-8 w-full md:w-1/3 md:max-w-352 md:ml-30 md:mr-30 relative">
                    ...
                    <a 
                        v-if="column3.ctaLink" 
                        class="pt-24 flex items-center h text-12 md:text-16 inline--button-grey"
                        :class="[column3.isCardStyle ? 'absolute mb-40 bottom-0' : null]" 
                        :href="column3.ctaLink"
                        >
                            {{column3.ctaText}}
                            <span class="ml-6">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
