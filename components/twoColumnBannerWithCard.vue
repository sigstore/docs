    ...
    >
        <div class="lg:flex justify-between container inner" :class="[textAlignment != 'textRight' ? 'items-start' : 'items-start']">
            ...
            <div v-if="!card" v-animate-on-scroll class="w-full lg:w-1/2 step-delay_5">
                ...
                <div v-else class="markdown text-purple-dark" v-html="$md.render(text)"></div>
            </div>
        </div>
        <div class="container container--card">
            <div class="rounded-xl md:bg-white p-0 md:p-32 lg:p-64 mt-64 md:mt-128 w-full mx-auto px-24 md:px-0">
                <div class="w-full lg:w-1/2 p-32 md:p-0 bg-white md:bg-transparent md:rounded-none rounded-xl text-purple-dark">
                    <h4 class="text-36 leading-44 mb-28">{{ cardTitle }}</h4>
                ...
                <div class="lg:flex items-start justify-between md:-ml-10 md:-mr-10 mt-32 md:mt-64">
                    <div class="mb-32 md:mb-16 w-full md:w-1/3 md:px-10 p-32 md:p-0 bg-white md:bg-transparent md:rounded-none rounded-xl md:max-w-315">
                        ...
                        <h4 class="mb-24 text-24 leading-32 text-purple-dark">{{column1.header}}</h4>
                        <p class="text-gray-dark">{{column1.text}}</p>
                    </div>
                    <div class="mb-32 md:mb-16 w-full md:w-1/3 md:px-10 p-32 md:p-0 bg-white md:bg-transparent md:rounded-none rounded-xl md:max-w-315">
                        <img :src="column2.imageAsset" class="mb-24" />
                        <h4 class="mb-24 text-24 leading-32 text-purple-dark">{{column2.header}}</h4>
                    ...
                    <div class="mb-0 md:mb-16 w-full md:w-1/3 md:px-10 p-32 md:p-0 bg-white md:bg-transparent md:rounded-none rounded-xl md:max-w-315">
                        ...
                        <h4 class="mb-24 text-24 leading-32 text-purple-dark">{{column3.header}}</h4>
